    ...
    <div className="flex flex-col h-full bg-[var(--color-canvas)]">
      <div className="flex items-center justify-between gap-3 px-4 pt-4">
        <div className="flex items-center gap-2 min-w-0">
          <span className="text-[10px] font-mono text-[var(--color-accent-cobalt)] font-bold px-2 py-0.5 rounded bg-[var(--color-info-bg)] border border-[var(--color-accent-cobalt)]">GAT TERMINAL</span>
      ...
      <div className="flex bg-[var(--color-surface-1)] rounded-lg p-1 border border-[var(--color-border)] mx-4 mt-3 mb-1 max-w-lg lg:mx-auto">
        <button
